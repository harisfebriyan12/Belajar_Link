...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php if($errors->any()): ?>
        <?php if(old('_method') === 'PUT'): ?>
            ...
            if (editModal) {
                const form = document.getElementById('edit-form');
                form.action = `/links/<?php echo e(old('id')); ?>`;
                ...
                document.getElementById('edit-url').value = '<?php echo e(old('url')); ?>';
                openModal(editModal);
            }
        <?php else: ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 md:p-6 mb-8">
            ...
            <div class="search-container max-w-md">
                <form action="<?php echo e(route('links.index')); ?>" method="GET">
                    <div class="relative">
                        ...
                        <tr class="table-row bg-white hover:bg-gray-50">
                            <td data-label="No" class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                <span class="inline-flex items-center justify-center h-8 w-8 rounded-full bg-blue-100 text-blue-600 font-semibold">
                                    <?php echo e($links->firstItem() + $index); ?>

                                </span>
                            </td>
                            <td data-label="Judul" class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e(Str::limit($link->judul, 30)); ?></td>
                            <td data-label="Link" class="px-6 py-4 text-sm text-blue-600">
                                <a href="<?php echo e($link->url); ?>" target="_blank" class="hover:underline truncate block max-w-[150px] md:max-w-[250px]"><?php echo e(Str::limit($link->url, 25)); ?></a>
                            </td>
                            <td data-label="Aksi" class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center justify-end space-x-3">
                                    <button class="action-btn p-2 text-blue-600 hover:text-blue-800 hover:bg-blue-100 rounded-full transition-colors duration-200 detail-link-btn"
                                            title="Detail <?php echo e($link->judul); ?>"
                                            data-judul="<?php echo e(e($link->judul)); ?>"
                                            data-deskripsi="<?php echo e(e($link->deskripsi)); ?>"
                                            data-url="<?php echo e(e($link->url)); ?>"
                                            data-gambar="<?php echo e($link->gambar ? asset('storage/' . $link->gambar) : ''); ?>"
                                            data-created_at="<?php echo e($link->created_at->format('d M Y, H:i')); ?>"
                                            data-updated_at="<?php echo e($link->updated_at->format('d M Y, H:i')); ?>"
                                            aria-label="Lihat detail <?php echo e($link->judul); ?>">
                                    ...
                                    <button class="action-btn p-2 text-green-600 hover:text-green-800 hover:bg-green-100 rounded-full transition-colors duration-200 edit-link-btn"
                                            title="Edit <?php echo e($link->judul); ?>"
                                            data-id="<?php echo e($link->id); ?>"
                                            data-judul="<?php echo e(e($link->judul)); ?>"
                                            data-deskripsi="<?php echo e(e($link->deskripsi)); ?>"
                                            data-url="<?php echo e(e($link->url)); ?>"
                                            aria-label="Edit <?php echo e($link->judul); ?>">
                                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                        </svg>
                                    </button>
                                    <form action="<?php echo e(route('links.destroy', $link->id)); ?>" method="POST" class="inline delete-form">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <button type="button" class="action-btn p-2 text-red-600 hover:text-red-800 hover:bg-red-100 rounded-full transition-colors duration-200 delete-button"
                                                title="Hapus <?php echo e($link->judul); ?>"
                                                aria-label="Hapus <?php echo e($link->judul); ?>">
                                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <tr>
                            <td colspan="8" class="px-6 py-8 text-center text-gray-500 text-lg">
                                <?php if(request('search')): ?>
                                    Tidak ada link yang cocok dengan pencarian "<?php echo e(request('search')); ?>".
                                <?php else: ?>
                                    Tidak ada data link.
                                <?php endif; ?>
                            </td>
...
<?php echo $__env->make('layouts.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\portalWebn\resources\views/links/index.blade.php ENDPATH**/ ?>