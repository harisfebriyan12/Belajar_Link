                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="table-row bg-white">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e(Str::limit($link->judul, 30)); ?></td>
                            <td class="px-6 py-4 text-sm text-gray-600 line-clamp-2 max-w-md"><?php echo e(Str::limit($link->deskripsi, 50)); ?></td>
