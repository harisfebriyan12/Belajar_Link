...
<body class="bg-gradient-to-br from-gray-100 to-gray-300 min-h-screen flex items-center justify-center px-4">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 sm:p-10 transition-all duration-300 ease-in-out">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>" id="registerForm" class="space-y-5">
            <?php echo csrf_field(); ?>
            ...
            <div class="text-center pt-2">
                <p class="text-sm text-gray-600">
                    Sudah punya akun?
                    <a href="<?php echo e(route('login')); ?>" class="font-medium text-blue-800 hover:text-blue-700">
                        Masuk di sini
                    </a>
                </p>
            </div>
...
<?php /**PATH C:\xampp\htdocs\portalWebn\resources\views/auth/register.blade.php ENDPATH**/ ?>