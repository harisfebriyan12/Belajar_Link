...
<div x-data="{ collapsed: false, sidebarOpen: false }" @keydown.escape.window="sidebarOpen = false" class="relative min-h-screen">
    ...
    >
        ...
        <nav class="py-4 flex-1">
            <ul>
                <li>
                    <a href="<?php echo e(route('dashboard')); ?>" wire:navigate class="flex items-center px-4 py-3 text-sm font-medium rounded-lg group transition-all duration-200 <?php echo e(request()->routeIs('dashboard') ? 'bg-blue-700 text-white' : 'text-blue-100 hover:bg-blue-600 hover:text-white'); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('links.index')); ?>" wire:navigate class="flex items-center px-4 py-3 text-sm font-medium rounded-lg group transition-all duration-200 <?php echo e(request()->routeIs('links.index') ? 'bg-blue-700 text-white' : 'text-blue-100 hover:bg-blue-600 hover:text-white'); ?>">
                        <svg class="mr-3 h-5 w-5 text-blue-200 group-hover:text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="<?php echo e(route('judul-halaman.index')); ?>" wire:navigate class="flex items-center px-4 py-3 text-sm font-medium rounded-lg group transition-all duration-200 <?php echo e(request()->routeIs('judul-halaman.index') ? 'bg-blue-700 text-white' : 'text-blue-100 hover:bg-blue-600 hover:text-white'); ?>">
                        <svg class="mr-3 h-5 w-5 text-blue-200 group-hover:text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
