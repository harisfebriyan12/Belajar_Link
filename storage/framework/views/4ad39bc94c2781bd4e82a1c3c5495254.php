    ...
    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $judulHalamans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $judul): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition-colors duration-200 align-middle">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php if($judul->images): ?>
                                        <img src="<?php echo e(asset('storage/' . $judul->images)); ?>" alt="Avatar" class="h-10 w-10 rounded-full object-cover">
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e($judul->judul); ?></td>
                                <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($judul->deskripsi); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <button onclick="toggleStatus(<?php echo e($judul->id); ?>, <?php echo e(!$judul->is_active); ?>, '<?php echo e(e($judul->judul)); ?>')"
                                            class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium transition-colors
                                                   <?php echo e($judul->is_active ? 'bg-green-100 text-green-800 hover:bg-green-200' : 'bg-red-100 text-red-800 hover:bg-red-200'); ?>">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($judul->created_at->format('d M Y, H:i')); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($judul->updated_at->format('d M Y, H:i')); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        <button onclick="editJudul(<?php echo e($judul->id); ?>, '<?php echo e(e($judul->judul)); ?>', '<?php echo e(e($judul->deskripsi)); ?>', <?php echo e($judul->is_active ? 'true' : 'false'); ?>, <?php echo e($judul->images ? "'" . asset('storage/' . $judul->images) . "'" : 'null'); ?>)"
                                        ...
                                        <button onclick="confirmDelete(<?php echo e($judul->id); ?>, '<?php echo e(e($judul->judul)); ?>')"
            ...
            <div class="px-6 py-4 bg-gray-50 border-t">
                <?php echo e($judulHalamans->links()); ?>
...
<script>
    function openModal() {
        ...
        form.action = "<?php echo e(route('judul-halaman.store')); ?>";
    ...
    function toggleStatus(id, newStatus, judul) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.innerHTML = `<?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?><input type="hidden" name="is_active" value="${newStatus}">`;
                document.body.appendChild(form);
                form.submit();
            }
        });
